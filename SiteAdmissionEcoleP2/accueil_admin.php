...
<html lang="en">
  ...
  <body>
    ...
    <h3>Enyoyer un message tous les utilisateurs</h3>
    <form  action="enregis_mess_admin.php" method="post">
      <br>
      <br>
      <p><label>Tapez le message que vous allez envoyé a tout le monde</label></p>
      ...
      <input type="button" class="generer" value="Générer les comptes étudiants" onclick="window.location.href='enregistrerGenerer.php'">
    </form>
    </div>
    <p><span class="vertical"></span></p>

  <div class="message">
    <h3>Les messages que vous avez envoyé a tous les utilisateurs </h3>
    <?php
      $lignes=array();
      ...
      for ($i=0; $i < sizeof($reverse)-1 ; $i++){
        ...
        echo '<div class="recu">';
        echo "<br>";
        echo " Vous avez envoyée le ".$date." :";
        echo "<br>";
        echo $message;
        echo "<br>";
        echo "<br>";
