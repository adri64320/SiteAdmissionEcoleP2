...
<html lang="en">
  ...
  <body>
    <div class='container'>
    <div class="filiere">
<form  method="POST" id="changementMI" class="formulaire">
      <div><select name="eleveMI" id="eleveMI">
      <?php
        $eleves=array();
    ...
    echo '<input type="hidden" id ="hpda" value="'.$hpda.'">
          ...
          <input type="hidden" id ="ft" value="'.$ft.'">
          <input type="hidden" id ="iac" value="'.$iac.'">
...
<script type="text/javascript" src ="corrigerElevesMi.js"></script>
